...
function showResult(e) {
  ...
  var thresholdPowerValue = document.getElementById("select-pth");
  var selectedThresholdPowerValue = thresholdPowerValue.options[thresholdPowerValue.selectedIndex].value;
  var formulaParameters = {};
  var antennaDistance = null;
  formulaParameters.thresholdPower = selectedThresholdPowerValue;

  var _iterator = _createForOfIteratorHelper(inputLists),
      _step;
  ...
  var impedenceMismatch = formulaParameters.impedenceMismatch,
      receiverEffiency = formulaParameters.receiverEffiency,
      thresholdPower = formulaParameters.thresholdPower,
      receiverPower = formulaParameters.receiverPower,
      receiverGain = formulaParameters.receiverGain,
      transmitterGain = formulaParameters.transmitterGain,
...
//# sourceMappingURL=/Ezuea-final-year-project.e31bb0bc.js.map